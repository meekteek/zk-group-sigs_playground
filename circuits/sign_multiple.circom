...
// create a version where you are signing two messages. 
template Main(GROUP_SIZE) {
  ...
  component mimcAttestation = MiMCSponge(3, 220, 1);
  mimcAttestation.ins[0] <== msg1;
  mimcAttestation.ins[1] <== msg2;
  mimcAttestation.ins[2] <== secret;
  mimcAttestation.k <== 0;
